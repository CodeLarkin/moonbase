...
contract MoonbaseShips is ERC1155, Ownable, AccessControl {
    ...
    function _changeItem_Name(
        ...
        itemById[index] = Item(
            ...
            theItem.totalSupply,
            theItem.cost,
            theItem.shield_capacity,
            theItem.cargo_holds,
            theItem.hardware_slots,
            theItem.top_speed,
            theItem.turning,
            theItem.thrust,
            theItem.energy_regen,
            theItem.fuel_per_warp
            );
    ...
    constructor() Ownable() {
        ...
        addItem(1,'Budget Bird','','',91,80,55,8,7,6,6,8,90);
        addItem(2,'Merchant Mk. I','','',98,70,45,8,4,6,5,4,90);
        addItem(3,'Magellan Mk. I','','',115,80,50,8,8,6,6,5,70);
        addItem(4,'Barge','','',119,70,100,24,5,6,7,4,110);
        addItem(5,'Merchant Mk. II','','',144,120,100,8,6,7,6,7,80);
        addItem(6,'Bomber','','',182,70,30,8,3,4,4,7,110);
        addItem(7,'Battleship','','',330,140,50,8,8,7,7,8,100);
        addItem(8,'Merchant Mk. III','','',345,65,250,8,4,3,2,3,110);
        addItem(9,'Stealth','','',350,80,50,8,8,7,7,8,90);
        addItem(10,'Merchant Mk. IV','','',595,80,160,8,8,6,4,6,90);
        addItem(11,'Magellan Mk. II','','',850,120,100,8,8,4,4,4,60);
        addItem(12,'Corporate Flagship','','',970,160,200,16,8,4,3,8,80);
        addItem(13,'Destroyer','','',1250,160,110,8,8,9,8,9,90);
        addItem(14,'Imperial Battleship','','',2000,160,150,8,9,6,7,9,90);
        addItem(15,'Intergalactic Battleship','','',0,160,160,16,8,9,8,9,80);
        addItem(16,'Escape Pod','','',0,10,1,2,8,6,7,3,90);
