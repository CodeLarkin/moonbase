...
contract MoonbaseResources is ERC1155, Ownable, AccessControl {
    
    string public name = "PermaverseAlpha Resources";
    string public symbol = "paRES";
    ...
    function _addItem(
        ...
        itemById[id] = Item(id, _name, description, imgdata, 0);
    } 
    ...
    function addItem(
        ...
        _addItem(id, _name, description, imgdata);
    }
    ...
    function _changeItem_Name(
        ...
        itemById[index] = Item(theItem.id, _name, theItem.description, theItem.imgdata, theItem.totalSupply);
    } 
    ...
    function _changeItem_Description(
        ...
        Item memory theItem = itemById[index];
        itemById[index] = Item(index, theItem.name, description, theItem.imgdata, theItem.totalSupply);
    } 
    ...
    function _changeItem_ImgData(
        ...
        Item memory theItem = itemById[index];
        itemById[index] = Item(index, theItem.name, theItem.description, imgdata, theItem.totalSupply);
    } 
    ...
    function mint(address to, uint256 id, uint256 amount) external {
        ...
        itemById[id].totalSupply = theItem.totalSupply + amount;
    ...
    constructor() Ownable() {
        ...
        addItem(
           1, 
           "Credits",
           "The primary currency in Moonbase Permaverse Alpha",
           "");
